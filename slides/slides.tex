...
\begin{frame}[fragile]{\texttt{whoami}}
    \begin{columns}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[scale=0.15]{profile-luciano.png}
...
\begin{frame}[fragile]{Getting in context (cont.)}
    \begin{itemize}
        ...
        \item These polls were (and still are) completed  and then exported to a \texttt{xls} (Excel file) \emoji{eyes.png}
...
\begin{frame}[fragile]{PyConAR 2018 Bonus Track}
    \LARGE
    \textbf{DOCKER IS NOT THE SOLUTION FOR EVERYTHING}
\end{frame}
...
\begin{frame}[fragile]{}
    \begin{center}
        \Large 
        We listen to your questions \emoji{cowboy.png}
    \end{center}
\end{frame}
